...
async function competitionFormula(){
  ...
  set(`${infoHero(
    ...
    'Dalla stagione regolare all’assegnazione dei premi: ecco come si sviluppa una stagione di Prime League.',
    '🏆'
  )}

  <section class="info-section formula-intro">
    <div class="info-section-heading">
      <span>01 · Campionato</span>
      <h2>La stagione regolare</h2>
      <p>Tutte le squadre si affrontano in un campionato con gare di andata e ritorno. Ogni giornata viene programmata principalmente tra mercoledì, giovedì e venerdì.</p>
    </div>

    <div class="formula-points">
      <article><b>3</b><span>punti per la vittoria</span></article>
      <article><b>1</b><span>punto per il pareggio</span></article>
      <article><b>0</b><span>punti per la sconfitta</span></article>
    </div>
  </section>

  <section class="info-section">
    <div class="info-section-heading">
      <span>02 · Classifica</span>
      <h2>Come viene determinata</h2>
      <p>La classifica viene aggiornata dopo l’approvazione dei referti ufficiali da parte dell’organizzazione.</p>
    </div>

    <div class="criteria-grid">
      <article><span>1</span><div><strong>Punti conquistati</strong><small>Il criterio principale della classifica.</small></div></article>
      <article><span>2</span><div><strong>Differenza reti</strong><small>La differenza tra gol realizzati e subiti.</small></div></article>
      <article><span>3</span><div><strong>Gol realizzati</strong><small>La squadra che ha segnato di più.</small></div></article>
      <article><span>4</span><div><strong>Scontri diretti</strong><small>Confronto tra le squadre a pari merito.</small></div></article>
    </div>
    <p class="info-note">Gli eventuali ulteriori criteri di parità vengono definiti nel regolamento ufficiale della stagione.</p>
  </section>

  <section class="champion-section">
    <div class="champion-cup">🏆</div>
    <div>
      <span>Il traguardo principale</span>
      <h2>Campione Prime League</h2>
      <p>La squadra che conclude la stagione regolare al primo posto viene proclamata Campione Prime League e vince ufficialmente il campionato.</p>
      <div class="champion-prizes">
        <span>Coppa ufficiale</span>
        <span>Medaglie</span>
        <span>Premio principale</span>
        <span>Accesso alle competizioni CSI previste</span>
      </div>
    </div>
  </section>
  ...
  <section class="info-section">
    <div class="info-section-heading">
      <span>03 · Fase premio</span>
      <h2>Mini torneo dal 2º al 5º posto</h2>
      <p>Le squadre classificate dal secondo al quinto posto accedono a una competizione separata, che assegna il premio secondario della stagione senza modificare la classifica del campionato.</p>
    </div>

    <div class="formula-bracket">
      <div class="formula-round">
        <h3>Semifinali</h3>
        <div class="formula-match"><span>2ª classificata</span><b>VS</b><span>5ª classificata</span></div>
        <div class="formula-match"><span>3ª classificata</span><b>VS</b><span>4ª classificata</span></div>
      </div>
      <div class="formula-arrow">→</div>
      <div class="formula-round formula-final">
        <h3>Finale premio</h3>
        <div class="formula-match"><span>Vincente SF1</span><b>VS</b><span>Vincente SF2</span></div>
      </div>
    </div>

    <div class="info-callout">
      <strong>Campionato e mini torneo sono due risultati distinti.</strong>
      <p>Il Campione Prime League resta la squadra prima classificata al termine della stagione regolare. Il mini torneo assegna un premio separato.</p>
    </div>
  </section>

  <section class="info-section">
    <div class="info-section-heading">
      <span>04 · Svolgimento</span>
      <h2>Le fasi della stagione</h2>
    </div>

    <div class="season-timeline">
      <article><b>01</b><span>Iscrizioni e tesseramenti</span></article>
      <article><b>02</b><span>Girone di andata</span></article>
      <article><b>03</b><span>Pausa mercato di 20 giorni</span></article>
      <article><b>04</b><span>Girone di ritorno</span></article>
      <article><b>05</b><span>Campione Prime League</span></article>
      <article><b>06</b><span>Mini torneo premio</span></article>
      <article><b>07</b><span>Premiazioni finali</span></article>
    </div>
  </section>

  <section class="info-section">
    <div class="info-section-heading">
      <span>05 · Premi individuali</span>
      <h2>I protagonisti della stagione</h2>
      <p>Le statistiche ufficiali vengono aggiornate attraverso i referti approvati.</p>
    </div>

    <div class="award-grid">
      <article><span>⚽</span><h3>Capocannoniere</h3><p>Il giocatore che realizza il maggior numero di gol.</p></article>
      <article><span>⭐</span><h3>MVP</h3><p>I migliori protagonisti delle partite e della stagione.</p></article>
      <article><span>🎯</span><h3>Assist</h3><p>La classifica dei giocatori con più passaggi decisivi.</p></article>
      <article><span>🟨</span><h3>Disciplina</h3><p>Cartellini e provvedimenti registrati nei referti ufficiali.</p></article>
    </div>
  </section>

  <section class="info-final-cta">
    <div><span>Segui la stagione</span><h2>Tutto il campionato, in un unico posto.</h2></div>
    <div><a class="btn primary" href="#/classifica">Vedi la classifica</a><a class="btn" href="#/competizioni">Competizioni</a></div>
  </section>`,'formula');
}
...
function dashLayout(body,section='overview'){
  const league=[['overview','Panoramica'],['seasons','Stagioni'],['competitions','Competizioni'],['calendar','Calendario'],['matches','Partite'],['teams','Squadre'],['players','Giocatori'],['submissions','Referti'],['media','Media'],['sponsors','Sponsor'],['news','News'],['faq-admin','FAQ'],['polls','Votazioni']];
